...
class ipb3_008 extends ipb3_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$poll_array 	= $this->get_ipb3_poll_details($Db_source, $source_database_type, $source_table_prefix, $poll_start_at, $poll_per_page, $displayobject);
		...
		foreach ($poll_array as $poll_id => $poll)
		{
			...
			$ipb_voters_array		= $this->get_ipb3_vote_voters($Db_source, $source_database_type, $source_table_prefix, $poll['tid'], $displayobject);
